...
public class ChooseMedActivity extends BannerActivity implements OnItemClickListener {
	...
	public class GetMedicines extends AsyncTask<String, Void, ArrayList<String>> {
		...
		protected ArrayList<String> doInBackground(String... arg0) {
			...
			public ArrayList<String> parseXML(XmlPullParser parser) throws XmlPullParserException, IOException {
		    ...
		    protected void onPostExecute(ArrayList<String> result) {
		        ...
		        //update the adapter
		        adapter = new ArrayAdapter<String>(getBaseContext(), R.layout.med_list_item);
		        ...
		        Logger.d("YourApp", "onPostExecute : autoCompleteAdapter" + adapter.getCount());
		    }
	}
	
	////GET MEDICINE NAME//////
	public class GetMedicineName extends AsyncTask<String, Void, ArrayList<String>> {
